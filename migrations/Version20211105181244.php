 ...
 */
final class Version20211105181244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE article SET author_id = (SELECT id FROM user WHERE email = \'admin@shinigami.com\')');
